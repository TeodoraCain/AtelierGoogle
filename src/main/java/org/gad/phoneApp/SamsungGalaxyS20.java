...
public class SamsungGalaxyS20 extends Samsung {
    ...
    public void sendMessage(String contactNumber, String message) {
        if (this.battery >= 1) {
            ...
            if (!contactExists) {
                ...
                System.out.println("New message sent to " + contactNumber + " from your Samsung Galaxy S20." +
    ...
    public void call(String contactNumber) {
        if (battery >= 2) {
            ...
            battery = battery - 3;
            System.out.println("Calling " + contactNumber + " from your Samsung Galaxy S20." +
                    "\nBattery left : " + battery);
        } else {
            System.out.println("Not enough battery left.");
        }

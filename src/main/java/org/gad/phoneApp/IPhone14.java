...
public class IPhone14 extends Apple {
    ...
    private int battery = this.batteryLife + 14;
    ...
    public void sendMessage(String contactNumber, String message) {
        if (this.battery >= 1) {
            ...
            if (!contactExists) {
                ...
                System.out.println("New message sent to " + contactNumber + " from your IPhone14." +
    ...
    public void call(String contactNumber) {
        if (battery >= 2) {
            ...
            battery = battery - 3;
            System.out.println("Calling " + contactNumber + " from your IPhone14." +
                    "\nBattery left : " + battery);
        } else {
            System.out.println("Not enough battery left.");
        }
